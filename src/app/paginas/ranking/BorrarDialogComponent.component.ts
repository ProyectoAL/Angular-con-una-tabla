...
@Component({
    ...
    templateUrl: './BorrarDialogComponent.component.html',
    styleUrls: ['./BorrarDialogComponent.component.css']
})
...
export class BorrarDialogComponent {
    ...
    // Constructor.
    constructor(public dialogRef: MatDialogRef<BorrarDialogComponent>,
